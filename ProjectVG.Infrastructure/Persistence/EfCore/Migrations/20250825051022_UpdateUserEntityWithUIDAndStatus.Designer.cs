...
namespace ProjectVG.Infrastructure.Persistence.EfCore
{
    ...
    [Migration("20250825051022_UpdateUserEntityWithUIDAndStatus")]
    partial class UpdateUserEntityWithUIDAndStatus
    {
        /// <summary>
        /// 마이그레이션 대상(20250825051022_UpdateUserEntityWithUIDAndStatus)의 EF Core 모델을 구성합니다.
        /// </summary>
        /// <remarks>
        /// 모델 빌더에 대해 SQL Server 아이덴티티 컬럼 설정을 적용하고 Characters, ConversationHistories, Users 엔티티의 테이블/컬럼 제약, 인덱스, 외래키 관계(캐스케이드 삭제 포함) 및 시드 데이터를 설정합니다.
        /// 이 구현은 마이그레이션 이후의 대상 모델(스키마 및 시드 레코드)을 정확히 재현하도록 설계되어 있습니다.
        /// </remarks>
            ...
            modelBuilder.Entity("ProjectVG.Domain.Entities.Characters.Character", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 5, 10, 22, 188, DateTimeKind.Utc).AddTicks(4397),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 5, 10, 22, 188, DateTimeKind.Utc).AddTicks(4398),
                            VoiceId = "haru"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 5, 10, 22, 188, DateTimeKind.Utc).AddTicks(4402),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 5, 10, 22, 188, DateTimeKind.Utc).AddTicks(4403),
                            VoiceId = "miya"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 5, 10, 22, 188, DateTimeKind.Utc).AddTicks(4406),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 5, 10, 22, 188, DateTimeKind.Utc).AddTicks(4406),
                            VoiceId = "sophia"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 5, 10, 22, 188, DateTimeKind.Utc).AddTicks(4408),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 5, 10, 22, 188, DateTimeKind.Utc).AddTicks(4408),
                            VoiceId = "amantha"
                        });
                });
            ...
            modelBuilder.Entity("ProjectVG.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 8, 25, 5, 10, 22, 188, DateTimeKind.Utc).AddTicks(4427),
                            Email = "test@test.com",
                            Provider = "test",
                            ProviderId = "test",
                            Status = 1,
                            UID = "TESTUSER001",
                            UpdatedAt = new DateTime(2025, 8, 25, 5, 10, 22, 188, DateTimeKind.Utc).AddTicks(4427),
                            Username = "testuser"
                        },
                        new
                        {
                            Id = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            CreatedAt = new DateTime(2025, 8, 25, 5, 10, 22, 188, DateTimeKind.Utc).AddTicks(4430),
                            Email = "zero@test.com",
                            Provider = "test",
                            ProviderId = "zero",
                            Status = 1,
                            UID = "ZEROUSER001",
                            UpdatedAt = new DateTime(2025, 8, 25, 5, 10, 22, 188, DateTimeKind.Utc).AddTicks(4430),
                            Username = "zerouser"
                        });
                });
