...
namespace ProjectVG.Infrastructure.Persistence.EfCore
{
    ...
    {
        /// <summary>
        /// 이 마이그레이션의 대상 EF Core 모델을 구성합니다.
        /// </summary>
        /// <param name="modelBuilder">이 마이그레이션(AddUIDToUser)에서 생성될 데이터베이스 스키마(엔티티, 속성, 인덱스, 관계 및 시드 데이터)를 구성하는 ModelBuilder 인스턴스입니다.</param>
