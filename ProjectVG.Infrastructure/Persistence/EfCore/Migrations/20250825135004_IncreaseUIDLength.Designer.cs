...
namespace ProjectVG.Infrastructure.Persistence.EfCore
{
    ...
    [Migration("20250825135004_IncreaseUIDLength")]
    partial class IncreaseUIDLength
    {
        /// <summary>
        /// 마이그레이션의 대상 EF Core 모델을 구성한다.
        /// </summary>
        /// <param name="modelBuilder">이 마이그레이션에서 구성할 엔터티, 속성, 인덱스, 외래키 및 시드 데이터를 설정하는 ModelBuilder 인스턴스.</param>
