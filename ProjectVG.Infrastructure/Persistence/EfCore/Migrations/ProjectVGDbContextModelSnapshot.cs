            ...
            modelBuilder.Entity("ProjectVG.Domain.Entities.Characters.Character", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 13, 50, 4, 368, DateTimeKind.Utc).AddTicks(1753),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 13, 50, 4, 368, DateTimeKind.Utc).AddTicks(1753),
                            VoiceId = "haru"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 13, 50, 4, 368, DateTimeKind.Utc).AddTicks(1756),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 13, 50, 4, 368, DateTimeKind.Utc).AddTicks(1756),
                            VoiceId = "miya"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 13, 50, 4, 368, DateTimeKind.Utc).AddTicks(1758),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 13, 50, 4, 368, DateTimeKind.Utc).AddTicks(1758),
                            VoiceId = "sophia"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 13, 50, 4, 368, DateTimeKind.Utc).AddTicks(1789),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 13, 50, 4, 368, DateTimeKind.Utc).AddTicks(1789),
                            VoiceId = "amantha"
                        });
                });
            ...
            modelBuilder.Entity("ProjectVG.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 8, 25, 13, 50, 4, 368, DateTimeKind.Utc).AddTicks(1801),
                            Email = "test@test.com",
                            Provider = "test",
                            ProviderId = "test",
                            Status = 0,
                            UID = "TESTUSER001",
                            UpdatedAt = new DateTime(2025, 8, 25, 13, 50, 4, 368, DateTimeKind.Utc).AddTicks(1801),
                            Username = "testuser"
                        },
                        new
                        {
                            Id = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            CreatedAt = new DateTime(2025, 8, 25, 13, 50, 4, 368, DateTimeKind.Utc).AddTicks(1803),
                            Email = "zero@test.com",
                            Provider = "test",
                            ProviderId = "zero",
                            Status = 0,
                            UID = "ZEROUSER001",
                            UpdatedAt = new DateTime(2025, 8, 25, 13, 50, 4, 368, DateTimeKind.Utc).AddTicks(1803),
                            Username = "zerouser"
                        });
                });
