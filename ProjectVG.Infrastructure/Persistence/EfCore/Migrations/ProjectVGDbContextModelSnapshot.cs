...
namespace ProjectVG.Infrastructure.Persistence.EfCore
{
    ...
    partial class ProjectVGDbContextModelSnapshot : ModelSnapshot
    {
        ...
        /// </summary>
        /// <remarks>
        /// DbContext 모델의 현재 상태를 ModelBuilder에 적용합니다. 이 구현은 엔티티 매핑(Characters, ConversationHistories, Users), 속성 타입과 제약, 키 및 인덱스, 관계(외래키 및 삭제 동작), 시드 데이터, 그리고 SQL Server용 identity 칼럼 설정과 관련 어노테이션을 정의합니다.
        /// 이 메서드는 마이그레이션 생성·적용 시 사용되는 스냅샷의 일부분이며 런타임에서 직접 호출할 목적으로 설계되지 않았습니다.
        /// </remarks>
            ...
            modelBuilder.Entity("ProjectVG.Domain.Entities.Characters.Character", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 28, 11, 5, 18, 233, DateTimeKind.Utc).AddTicks(3705),
                            ...
                            SpeechStyle = "",
                            Summary = "",
                            UpdatedAt = new DateTime(2025, 8, 28, 11, 5, 18, 233, DateTimeKind.Utc).AddTicks(3705),
                            UserAlias = "",
                            VoiceId = "haru"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 28, 11, 5, 18, 233, DateTimeKind.Utc).AddTicks(3707),
                            ...
                            SpeechStyle = "",
                            Summary = "",
                            UpdatedAt = new DateTime(2025, 8, 28, 11, 5, 18, 233, DateTimeKind.Utc).AddTicks(3708),
                            UserAlias = "",
                            VoiceId = "miya"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 28, 11, 5, 18, 233, DateTimeKind.Utc).AddTicks(3709),
                            ...
                            SpeechStyle = "",
                            Summary = "",
                            UpdatedAt = new DateTime(2025, 8, 28, 11, 5, 18, 233, DateTimeKind.Utc).AddTicks(3710),
                            UserAlias = "",
                            VoiceId = "sophia"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 28, 11, 5, 18, 233, DateTimeKind.Utc).AddTicks(3711),
                            ...
                            SpeechStyle = "",
                            Summary = "",
                            UpdatedAt = new DateTime(2025, 8, 28, 11, 5, 18, 233, DateTimeKind.Utc).AddTicks(3711),
                            UserAlias = "",
                            VoiceId = "amantha"
                        });
                });
            ...
            modelBuilder.Entity("ProjectVG.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 8, 28, 11, 5, 18, 233, DateTimeKind.Utc).AddTicks(3721),
                            Email = "test@test.com",
                            Provider = "test",
                            ProviderId = "test",
                            Status = 0,
                            UID = "TESTUSER001",
                            UpdatedAt = new DateTime(2025, 8, 28, 11, 5, 18, 233, DateTimeKind.Utc).AddTicks(3722),
                            Username = "testuser"
                        },
                        new
                        {
                            Id = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            CreatedAt = new DateTime(2025, 8, 28, 11, 5, 18, 233, DateTimeKind.Utc).AddTicks(3724),
                            Email = "zero@test.com",
                            Provider = "test",
                            ProviderId = "zero",
                            Status = 0,
                            UID = "ZEROUSER001",
                            UpdatedAt = new DateTime(2025, 8, 28, 11, 5, 18, 233, DateTimeKind.Utc).AddTicks(3724),
                            Username = "zerouser"
                        });
                });
