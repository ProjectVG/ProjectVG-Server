...
namespace ProjectVG.Infrastructure.Persistence.EfCore
{
    ...
    [Migration("20250825023955_AddUIDFieldToUser")]
    partial class AddUIDFieldToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectVG.Domain.Entities.Characters.Character", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 2, 39, 55, 748, DateTimeKind.Utc).AddTicks(8922),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 2, 39, 55, 748, DateTimeKind.Utc).AddTicks(8922),
                            VoiceId = "haru"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 2, 39, 55, 748, DateTimeKind.Utc).AddTicks(8925),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 2, 39, 55, 748, DateTimeKind.Utc).AddTicks(8925),
                            VoiceId = "miya"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 2, 39, 55, 748, DateTimeKind.Utc).AddTicks(8927),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 2, 39, 55, 748, DateTimeKind.Utc).AddTicks(8927),
                            VoiceId = "sophia"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 2, 39, 55, 748, DateTimeKind.Utc).AddTicks(8929),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 2, 39, 55, 748, DateTimeKind.Utc).AddTicks(8929),
                            VoiceId = "amantha"
                        });
                });
            ...
            modelBuilder.Entity("ProjectVG.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 8, 25, 2, 39, 55, 748, DateTimeKind.Utc).AddTicks(8942),
                            Email = "test@test.com",
                            IsActive = true,
                            Name = "Test User",
                            Provider = "test",
                            ProviderId = "test",
                            UID = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 2, 39, 55, 748, DateTimeKind.Utc).AddTicks(8943),
                            Username = "testuser"
                        },
                        new
                        {
                            Id = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            CreatedAt = new DateTime(2025, 8, 25, 2, 39, 55, 748, DateTimeKind.Utc).AddTicks(8944),
                            Email = "zero@test.com",
                            IsActive = true,
                            Name = "Zero User",
                            Provider = "test",
                            ProviderId = "zero",
                            UID = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 2, 39, 55, 748, DateTimeKind.Utc).AddTicks(8945),
                            Username = "zerouser"
                        });
                });
