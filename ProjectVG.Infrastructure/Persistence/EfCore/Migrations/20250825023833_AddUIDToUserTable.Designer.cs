...
namespace ProjectVG.Infrastructure.Persistence.EfCore
{
    ...
    [Migration("20250825023833_AddUIDToUserTable")]
    partial class AddUIDToUserTable
    {
        /// <summary>
        /// 마이그레이션의 대상 모델을 구성합니다.
        /// </summary>
        /// <remarks>
        /// 모델 빌더에 대해 SQL Server 식별자 길이 및 제품 버전을 설정하고(identity columns 포함),
        /// 엔티티 매핑(Characters, ConversationHistories, Users), 열 속성, 키, 인덱스, 외래키 관계(필수 관계 및 캐스케이드 삭제 포함),
        /// 및 초기 시드 데이터를 구성합니다. 이 구성은 해당 마이그레이션(AddUIDToUserTable)의 타깃 데이터베이스 스키마를 정의합니다.
        /// </remarks>
            ...
            modelBuilder.Entity("ProjectVG.Domain.Entities.Characters.Character", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 2, 38, 33, 60, DateTimeKind.Utc).AddTicks(3933),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 2, 38, 33, 60, DateTimeKind.Utc).AddTicks(3933),
                            VoiceId = "haru"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 2, 38, 33, 60, DateTimeKind.Utc).AddTicks(3936),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 2, 38, 33, 60, DateTimeKind.Utc).AddTicks(3936),
                            VoiceId = "miya"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 2, 38, 33, 60, DateTimeKind.Utc).AddTicks(3938),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 2, 38, 33, 60, DateTimeKind.Utc).AddTicks(3939),
                            VoiceId = "sophia"
                        },
                        new
                        {
                            ...
                            Background = "",
                            CreatedAt = new DateTime(2025, 8, 25, 2, 38, 33, 60, DateTimeKind.Utc).AddTicks(3940),
                            ...
                            SpeechStyle = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 2, 38, 33, 60, DateTimeKind.Utc).AddTicks(3941),
                            VoiceId = "amantha"
                        });
                });
            ...
            modelBuilder.Entity("ProjectVG.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 8, 25, 2, 38, 33, 60, DateTimeKind.Utc).AddTicks(3952),
                            Email = "test@test.com",
                            IsActive = true,
                            Name = "Test User",
                            Provider = "test",
                            ProviderId = "test",
                            UID = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 2, 38, 33, 60, DateTimeKind.Utc).AddTicks(3952),
                            Username = "testuser"
                        },
                        new
                        {
                            Id = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            CreatedAt = new DateTime(2025, 8, 25, 2, 38, 33, 60, DateTimeKind.Utc).AddTicks(3954),
                            Email = "zero@test.com",
                            IsActive = true,
                            Name = "Zero User",
                            Provider = "test",
                            ProviderId = "zero",
                            UID = "",
                            UpdatedAt = new DateTime(2025, 8, 25, 2, 38, 33, 60, DateTimeKind.Utc).AddTicks(3954),
                            Username = "zerouser"
                        });
                });
