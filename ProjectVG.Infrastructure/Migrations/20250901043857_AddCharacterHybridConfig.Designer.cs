            ...
            modelBuilder.Entity("ProjectVG.Domain.Entities.Characters.Character", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfigMode = 0,
                            CreatedAt = new DateTime(2025, 9, 1, 4, 38, 57, 198, DateTimeKind.Utc).AddTicks(6307),
                            ...
                            IsActive = true,
                            Name = "하루",
                            UpdatedAt = new DateTime(2025, 9, 1, 4, 38, 57, 198, DateTimeKind.Utc).AddTicks(6308),
                            VoiceId = "haru"
                        },
                        new
                        {
                            ...
                            ConfigMode = 0,
                            CreatedAt = new DateTime(2025, 9, 1, 4, 38, 57, 198, DateTimeKind.Utc).AddTicks(6368),
                            ...
                            IsActive = true,
                            Name = "소피아",
                            UpdatedAt = new DateTime(2025, 9, 1, 4, 38, 57, 198, DateTimeKind.Utc).AddTicks(6368),
                            VoiceId = "sophia"
                        });
                });
            ...
            modelBuilder.Entity("ProjectVG.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 1, 4, 38, 57, 198, DateTimeKind.Utc).AddTicks(6387),
                            Email = "test@test.com",
                            Provider = "test",
                            ProviderId = "test",
                            Status = 0,
                            UID = "TESTUSER001",
                            UpdatedAt = new DateTime(2025, 9, 1, 4, 38, 57, 198, DateTimeKind.Utc).AddTicks(6387),
                            Username = "testuser"
                        },
                        new
                        {
                            Id = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            CreatedAt = new DateTime(2025, 9, 1, 4, 38, 57, 198, DateTimeKind.Utc).AddTicks(6389),
                            Email = "zero@test.com",
                            Provider = "test",
                            ProviderId = "zero",
                            Status = 0,
                            UID = "ZEROUSER001",
                            UpdatedAt = new DateTime(2025, 9, 1, 4, 38, 57, 198, DateTimeKind.Utc).AddTicks(6389),
                            Username = "zerouser"
                        });
                });
